...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference("Keyword.count") do
      post keywords_url, params: { keyword: { name: @keyword.name, search_engine: @keyword.search_engine, target_url: @keyword.target_url } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { name: @keyword.name, search_engine: @keyword.search_engine, target_url: @keyword.target_url } }
